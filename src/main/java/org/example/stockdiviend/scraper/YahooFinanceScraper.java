...
import org.example.stockdiviend.model.constants.Month;
...
public class YahooFinanceScraper implements Scraper {
    ...
    private static final String STATISTICS_URL = "https://finance.yahoo.com/quote/%s/history?period1=%d&period2=%d&interval=1mo&frequency=1mo";
    ...
    public ScrapedResult scrap(Company company) {
        ...
        try {
            ...
            Element tbody = tableEle.children().get(1);// children 으로 thead, tbody 가 있음
